...
// variable for storing letters already guessed 
var lettersUsed = [];

// variable for storing number of guesses user has left
var guessesRemaining = 10;

// variable for store the radomized letter the computer has chosen
...
// if the number of guesses remaining drops to 0 then the computer will alert the user of the correct letter, losses will increase by 1, letters guessed will reset, guesses remaining will be reset to 10, and the computer will choose a new letter
...
// prints the html variable to the screen in the div that matches the id "game"
